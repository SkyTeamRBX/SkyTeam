    ...
    <div className="pb-16">
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <div className="mx-auto max-w-6xl px-4 py-10">
            <div className="space-y-4 max-w-2xl">
              <h1 className="font-display text-4xl md:text-6xl font-extrabold tracking-tight">CARING MORE ABOUT YOU</h1>
              ...
              <div className="flex items-center gap-3">
                ...
                <Button variant="outline" asChild>
                  <a href="https://discord.gg/skyteam" target="_blank" rel="noreferrer">Join our Discord</a>
                </Button>
              </div>
            </div>
          </div>
      ...
      <Container>
        <section className="mt-16">
          <Link href="/blog" className="group flex items-center gap-2 mb-6">
            <h2 className="text-3xl font-bold font-display">WHAT'S NEW</h2>
            <svg
